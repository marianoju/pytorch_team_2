import numpy as np
import pandas as pd
from sklearn.metrics import mean_squared_error, r2_score, accuracy_score, classification_report, matthews_corrcoef, precision_score, recall_score, f1_score
...
def save_errors_classified(test, predicted, model, fit_time, pred_time):
    ...
    result = [accuracyscore, precisionscore, recallscore, f1score, matthewscorr ]
    config.results.append(result)
