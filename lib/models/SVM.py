...
def svm_regression (X_train, X_test, y_train, y_test, *,kernel='rbf', degree=3,
    ...
    svm = SVR(kernel=kernel, degree=degree, gamma=gamma, coef0=coef0, tol=tol, C=C, epsilon=epsilon, shrinking=shrinking,
...
def svm_classification (X_train, X_test, y_train, y_test, *,C=1.0, kernel='rbf', degree=3,
    ...
    svm = SVC(C=C,kernel=kernel,degree=degree,gamma=gamma,coef0=coef0, shrinking=shrinking,probability=probability,
