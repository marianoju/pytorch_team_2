...
def random_forest(X_train, X_test, y_train, y_test, *, n_estimators=10,
    ...
    evaluation.save_errors(y_test, rf_y_prediction, rf_model, rf_fit_time, rf_pred_time)

    return y_test, rf_y_prediction, rf_model, rf_fit_time, rf_pred_time


def random_forest_classifier(X_train, X_test, y_train, y_test, *, n_estimators=10,
    ...
    evaluation.save_errors_classified(y_test, rf_y_prediction, rf_model, rf_fit_time, rf_pred_time)
